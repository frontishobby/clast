...
Touch devices are pinned to portrait, so the on-screen sticks always sit where
thumbs are. Both sticks float — wherever your thumb lands becomes the centre,
so you never have to look down to find them.
